...
Follow the [official docs](https://docs.acquia.com/acquia-cloud/develop/api/auth/) to generate your Acquia Cloud API key.  
...
Please refer to the official [Acquia Cloud API](https://docs.acquia.com/acquia-cloud/develop/api/drush-reference/) for usage details.
...
For easier integration with Acquia environment use the [pull command](/fin/pull). 
